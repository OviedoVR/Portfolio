...
Pela mediana, podemos rapidamente que:
...
* Os quatro perfis de renda implicam em diferentes comportamento quanto ao total gasto.
* Os clusters B e C costumam comprar mais com desconto. O clsuter D quase não compra com desconto.
* Clusters A e B: baixo ticket médio (total gasto/total de compras). Clusters C e D: alto ticket.
