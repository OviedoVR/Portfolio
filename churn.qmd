...
![](assets/churn-cover.png){width=90%}
...
O arquivo em MS Excel pode ser encontrado [aqui](https://github.com/OviedoVR).
:::
...
|-----------------|-------|--------------------------------------|
| Contract        | 1,24  | Muito forte                          |
| Tenure          | 0,71  | muito forte                          |
